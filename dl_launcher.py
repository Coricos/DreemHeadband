...
if __name__ == '__main__':
    ...
    dic = {
           ...
           'with_eeg_enc': prs.eeg_tda == 'T',
           'with_eeg_ate': prs.eeg_tda == 'T',
           'with_eeg_l_0': prs.eeg_tda == 'T',
           'with_eeg_l_1': prs.eeg_tda == 'T',
           'with_n_e_cv1': prs.n_e_cv1 == 'T',
           'with_n_e_cvl': prs.n_e_cvl == 'T',
           'with_por_cv1': prs.por_cv1 == 'T',
           'with_por_cvl': prs.por_cvl == 'T',
           'with_por_enc': prs.eeg_tda == 'T',
           'with_por_ate': prs.eeg_tda == 'T',
           'with_poi_cv1': prs.poi_cv1 == 'T',
           'with_poi_cvl': prs.poi_cvl == 'T',
           'with_poi_enc': prs.poi_cvl == 'T',
           'with_poi_ate': prs.poi_cvl == 'T',
